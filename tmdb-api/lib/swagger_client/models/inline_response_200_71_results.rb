...
module SwaggerClient
  class InlineResponse20071Results
    attr_accessor :ae, :ar, :at, :au, :ba, :bb, :be, :bg, :bo, :br, :bs, :ca, :ch, :ci, :cl, :co, :cr, :cz, :de, :dk,
                  :_do, :dz, :ec, :eg, :es, :fi, :fr, :gb, :gf, :gh, :gq, :gt, :hk, :hn, :hr, :hu, :id, :ie, :il, :iq, :it, :jm, :jp, :ke, :kr, :lb, :lt, :ly, :md, :mk, :mu, :mx, :my, :mz, :ne, :ng, :nl, :no, :nz, :pa, :pe, :ph, :pl, :ps, :pt, :py, :ro, :rs, :ru, :sa, :sc, :se, :sg, :si, :sk, :sn, :sv, :th, :tr, :tt, :tw, :tz, :ug, :us, :uy, :ve, :za, :zm
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `SwaggerClient::InlineResponse20071Results` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless self.class.attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `SwaggerClient::InlineResponse20071Results`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
    ...
    def hash
      [ae, ar, at, au, ba, bb, be, bg, bo, br, bs, ca, ch, ci, cl, co, cr, cz, de, dk, _do, dz, ec, eg, es, fi, fr, gb,
       gf, gh, gq, gt, hk, hn, hr, hu, id, ie, il, iq, it, jm, jp, ke, kr, lb, lt, ly, md, mk, mu, mx, my, mz, ne, ng, nl, no, nz, pa, pe, ph, pl, ps, pt, py, ro, rs, ru, sa, sc, se, sg, si, sk, sn, sv, th, tr, tt, tw, tz, ug, us, uy, ve, za, zm].hash
    end
