...
module SwaggerClient
  class InlineResponse20091Certifications
    attr_accessor :au, :bg, :br, :ca, :ca_qc, :de, :dk, :es, :fi, :fr, :gb, :hu, :_in, :it, :lt, :my, :nl, :no, :nz,
                  :ph, :pt, :ru, :se, :us, :kr, :sk, :th, :mx, :id, :tr, :ar, :gr, :tw, :za, :sg, :ie, :pr, :jp, :vi, :ch, :il, :hk, :mo, :lv, :lu
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `SwaggerClient::InlineResponse20091Certifications` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless self.class.attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `SwaggerClient::InlineResponse20091Certifications`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
      ...
      self.vi = attributes[:vi] if attributes.key?(:vi)
      ...
      self.mo = attributes[:mo] if attributes.key?(:mo)

      self.lv = attributes[:lv] if attributes.key?(:lv)

      return unless attributes.key?(:lu)
    ...
    def hash
      [au, bg, br, ca, ca_qc, de, dk, es, fi, fr, gb, hu, _in, it, lt, my, nl, no, nz, ph, pt, ru, se, us, kr, sk, th,
       mx, id, tr, ar, gr, tw, za, sg, ie, pr, jp, vi, ch, il, hk, mo, lv, lu].hash
    end
